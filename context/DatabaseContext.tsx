...
async function seedAccounts(db: SQLite.SQLiteDatabase) {
  ...
  if (count[0]?.c > 0) { console.log('✅ الحسابات موجودة مسبقاً'); return; }

  console.log('📋 جاري إنشاء الحسابات الأساسية...');
  ...
  const subs = [
    ...
    ['21','21','الخصوم المتداولة','خصم','2'],['22','22','الخصوم طويلة الأجل','خصم','2'],
    ['31','31','رأس المال','ملكية','3'],['41','41','المبيعات','إيراد','4'],['51','51','المشتريات','مصروف','5'],
  ];
  for (const s of subs) {
  ...
  const grands = [
    ['111','111','الصندوق','أصل','11'],['112','112','البنوك','أصل','11'],['113','113','المحافظ الإلكترونية','أصل','11'],
    ['114','114','العملاء','أصل','11'],['115','115','المخزون','أصل','11'],
    ['211','211','الموردين','خصم','21'],['212','212','الضرائب المستحقة','خصم','21'],
    ['311','311','رأس المال المدفوع','ملكية','31'],['411','411','مبيعات نقدية','إيراد','41'],
    ['511','511','مشتريات بضائع','مصروف','51'],['512','512','رواتب وأجور','مصروف','51'],
    ['513','513','إيجارات','مصروف','51'],['514','514','مصاريف تشغيلية','مصروف','51'],
  ];
