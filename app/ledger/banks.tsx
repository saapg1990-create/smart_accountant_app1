...
export default function BanksScreen() {
  ...
  return (
    <View style={[st.c, { paddingTop: insets.top }]}>
      <ControlHeader title="البنوك" count={cashBoxes.length} onBack={() => router.back()} onAdd={() => { setFormData({ name: '', balance: '0' }); setShowModal(true); }} />
